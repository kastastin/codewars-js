...
function tongues(code) {
  const alpha = "aiyeoubkxznhdcwgpvjqtsrlmf";
  const repl = "eouaiypvjqtsrlmfbkxznhdcwg";
...
// <-- Best Solution -->
const ABC = "aiyeoubkxznhdcwgpvjqtsrlmfAIYEOUBKXZNHDCWGPVJQTSRLMF";
const ALT = "eouaiypvjqtsrlmfbkxznhdcwgEOUAIYPVJQTSRLMFBKXZNHDCWG";

const tonguesBest = (str) => str.replace(/[a-z]/gi, (c) => ALT[ABC.indexOf(c)]);
